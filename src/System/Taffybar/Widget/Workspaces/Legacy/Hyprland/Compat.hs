...
-- |
-- Module      : System.Taffybar.Widget.Workspaces.Legacy.Hyprland.Compat
...
import qualified System.Taffybar.Widget.Workspaces.Legacy.Hyprland as Hyprland
...
{-# DEPRECATED getWorkspaces "Legacy flat config field. Use `System.Taffybar.Widget.Workspaces.Legacy.Hyprland.getWorkspaces` on the canonical nested config type instead." #-}

{-# DEPRECATED switchToWorkspace "Legacy flat config field. Use `System.Taffybar.Widget.Workspaces.Legacy.Hyprland.switchToWorkspace` on the canonical nested config type instead." #-}

{-# DEPRECATED updateIntervalSeconds "Legacy flat config field. Use `System.Taffybar.Widget.Workspaces.Legacy.Hyprland.updateIntervalSeconds` on the canonical nested config type instead." #-}

{-# DEPRECATED widgetBuilder "Legacy flat config field. Use the nested `workspacesConfig` field in `System.Taffybar.Widget.Workspaces.Legacy.Hyprland.HyprlandWorkspacesConfig` instead." #-}

{-# DEPRECATED widgetGap "Legacy flat config field. Use the nested `workspacesConfig` field in `System.Taffybar.Widget.Workspaces.Legacy.Hyprland.HyprlandWorkspacesConfig` instead." #-}

{-# DEPRECATED maxIcons "Legacy flat config field. Use the nested `workspacesConfig` field in `System.Taffybar.Widget.Workspaces.Legacy.Hyprland.HyprlandWorkspacesConfig` instead." #-}

{-# DEPRECATED minIcons "Legacy flat config field. Use the nested `workspacesConfig` field in `System.Taffybar.Widget.Workspaces.Legacy.Hyprland.HyprlandWorkspacesConfig` instead." #-}

{-# DEPRECATED iconSize "Legacy flat config field. Use `System.Taffybar.Widget.Workspaces.Legacy.Hyprland.iconSize` on the canonical nested config type instead." #-}

{-# DEPRECATED getWindowIconPixbuf "Legacy flat config field. Use the nested `workspacesConfig` field in `System.Taffybar.Widget.Workspaces.Legacy.Hyprland.HyprlandWorkspacesConfig` instead." #-}

{-# DEPRECATED labelSetter "Legacy flat config field. Use the nested `workspacesConfig` field in `System.Taffybar.Widget.Workspaces.Legacy.Hyprland.HyprlandWorkspacesConfig` instead." #-}

{-# DEPRECATED showWorkspaceFn "Legacy flat config field. Use the nested `workspacesConfig` field in `System.Taffybar.Widget.Workspaces.Legacy.Hyprland.HyprlandWorkspacesConfig` instead." #-}

{-# DEPRECATED iconSort "Legacy flat config field. Use the nested `workspacesConfig` field in `System.Taffybar.Widget.Workspaces.Legacy.Hyprland.HyprlandWorkspacesConfig` instead." #-}

{-# DEPRECATED urgentWorkspaceState "Legacy flat config field. Use the nested `workspacesConfig` field in `System.Taffybar.Widget.Workspaces.Legacy.Hyprland.HyprlandWorkspacesConfig` instead." #-}
